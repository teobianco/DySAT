...
os.mkdir("/Users/teo/Desktop/Tesi_Magistrale/DySAT/data/stable_birth")

# Save the graph list
np.savez('/Users/teo/Desktop/Tesi_Magistrale/DySAT/data/stable_birth/graphs.npz', graph=graph_list)
# Save the attribute list
np.savez('/Users/teo/Desktop/Tesi_Magistrale/DySAT/data/stable_birth/features.npz', features=feature_mat_list)
# Save the labels list
np.savez('/Users/teo/Desktop/Tesi_Magistrale/DySAT/data/stable_birth/labels.npz', labels=labels_list)