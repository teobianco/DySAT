...
np.savez('/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/data/split_merge_split_mas_03/features.npz', features=feature_list)
# Save the labels list
np.savez('/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/data/split_merge_split_mas_03/labels.npz', labels=labels_list)