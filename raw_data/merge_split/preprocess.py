...
count = 0
dir_path = '/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/raw_data/merge_split/merge_split_data'  #path to the directory containing the graphs
...
for i in range(length):
    ...
    label_path = '/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/raw_data/merge_split/merge_split_groundtruth' + '/mergesplit.t0{n}.comm'.format(n=i+1)
...
os.mkdir("/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/data/merge_split")

# Save the graph list
np.savez('/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/data/merge_split/graphs.npz', graph=graph_list)
# Save the labels
np.savez('/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/data/merge_split/labels.npz', labels=labels)