...
count = 0
dir_path = '/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/raw_data/birth_death/birth_death_data'  #path to the directory containing the graphs
...
for i in range(length):
    ...
    label_path = '/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/raw_data/birth_death/birth_death_groundtruth' + '/birthdeath.t0{n}.comm'.format(n=i+1)
...
os.mkdir("/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/data/birth_death")

# Save the graph list
np.savez('/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/data/birth_death/graphs.npz', graph=graph_list)
# Save the labels
np.savez('/Users/teo/Desktop/Tesi Magistrale/FASE 1/DySAT_new/data/birth_death/labels.npz', labels=labels)