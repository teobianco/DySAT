...
os.mkdir("/Users/teo/Desktop/Tesi_Magistrale/DySAT/data/single_split")

# Save the graph list
np.savez('/Users/teo/Desktop/Tesi_Magistrale/DySAT/data/single_split/graphs.npz', graph=graph_list)
# Save the attribute list
np.savez('/Users/teo/Desktop/Tesi_Magistrale/DySAT/data/single_split/features.npz', features=feature_mat_list)
# Save the labels list
np.savez('/Users/teo/Desktop/Tesi_Magistrale/DySAT/data/single_split/labels.npz', labels=labels_list)